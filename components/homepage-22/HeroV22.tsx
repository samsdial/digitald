...
const HeroV22 = () => {
  return (
    <section className="relative h-[80vh] w-screen overflow-hidden lg:h-screen">
      ...
      <RevealWrapper className="reveal-me container absolute left-1/2 top-1/2 z-40 -translate-x-1/2 -translate-y-1/2 text-center md:top-1/2 lg:top-[45%] 2xl:top-1/2">
